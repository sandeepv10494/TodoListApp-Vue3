    ...
    <ion-page>
        ...
        <ion-content class="overflow-auto">
            <div class="flex flex-col justify-center items-center mt-2">
                ...
                <div class="text-center">
                    <ion-card-title class="text-2xl font-semibold">Work</ion-card-title>
                    <ion-card-subtitle>{{state.tasksWork.length}} Tasks</ion-card-subtitle>
                </div>
            </div>
            ...
            <div>
                <ion-list>
                    <ion-list-header>
                        <ion-label class="text-xl font-semibold">Late <span class="text-gray-600 text-base font-semibold">{{state.late.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label class="text-xl font-semibold">Today <span class="text-gray-600 text-base font-semibold">{{state.today.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label class="text-xl font-semibold">Later <span class="text-gray-600 text-base font-semibold">{{state.later.length}}</span></ion-label>
                    </ion-list-header>
                ...
                <ion-list>
                    <ion-list-header>
                        <ion-label class="text-xl font-semibold">Done <span class="text-gray-600 text-base font-semibold">{{state.done.length}}</span></ion-label>
                    </ion-list-header>
